...
Fallback: Per-time spatial fits + IVW
    ...
    `pubgrade_spatial_tost.py` as the core estimator, applied per time slice.
...
from .pubgrade_spatial_tost import _matern_cov  # correlation up to sigma2; we use sigma2 separately
from .pubgrade_spatial_tost import fit_matern_reml  # lr CI used only for per-time θ selection
